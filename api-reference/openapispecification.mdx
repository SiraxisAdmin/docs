---
title: 'OpenAPI'
description: 'OpenAPI specification for SlyceIO'
---

```json SlyceIO OpenAPI Specification
{
  "openapi": "3.0.1",
  "info": {
  ...
  "paths": {
    "/auth-token": {
      "post": {
        ...
        "servers": [
          {
            "url": "https://devauthapi.slyce-io.co.uk"
          }
        ],
        "security": [
          {
      ...
      "put": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "in": "header",
            "description": "Use the ETag value returned from the Create/Update/Retrieve request or use an asterix (*) to ignore versioning.",
            "required": true,
            "example": "*",
            "schema": {
              "type": "string"
          ...
          "412": {
            ...
            "content": {
              "application/json": {
                ...
                "example": "Document with Id has been updated by another user"
              }
            }
          },
          "429": {
