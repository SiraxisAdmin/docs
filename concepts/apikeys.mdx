...
Use the [authorization token endpoint](/api-reference/endpoint/authorization) to issue an encrypted bearer token for the required API key, which can then be used to access container data via the [document endpoints](/api-reference/endpoint/create).
